					...
					<tbody>
						...
						<tr class="prop">
							<td valign="top" class="name"><label for="userId"> <g:message
										code="user.userId.label" default="User ID" /></label></td>
							<td valign="top"
								class="value ${hasErrors(bean: userInstance, field: 'userId', 'errors')}">
						...
						<tr class="prop">
							...
							<td valign="top" class="value ${hasErrors(bean: userInstance, field: 'userId', 'errors')}">
								<g:link action="changepassword" id="${userInstance.id}"> Trocar Senha </g:link>
							</td>
						</tr>
					</tbody>
				</table>
